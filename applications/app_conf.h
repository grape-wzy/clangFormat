 ...
 */
#define BLE_MAX_ADV_INTERVAL_MS         (400)     /**< 400ms */
#define BLE_MIN_ADV_INTERVAL_MS         (200)     /**< 200ms */
 ...
 */
#define CFG_BLE_NUM_GATT_ATTRIBUTES (9 + 15) // 68

/**
 * Maximum supported ATT_MTU size
 * This parameter is ignored by the CPU2 when CFG_BLE_OPTIONS is set to 1"
 */
#define CFG_BLE_MAX_ATT_MTU             247//(251)//247
 ...
 * This parameter is ignored by the CPU2 when CFG_BLE_OPTIONS is set to 1"
 */
#define CFG_BLE_ATT_VALUE_ARRAY_SIZE  (1391 + 128)// (1360 + 25 +6)// (1344 + 400)
...
#define CFG_RTCCLK_DIV              (4)
#define CFG_RTC_WUCKSEL_DIVIDER     (RTC_WAKEUPCLOCK_RTCCLK_DIV4)
#define CFG_RTC_ASYNCH_PRESCALER    (0x03)
#define CFG_RTC_SYNCH_PRESCALER     (0x7FFF)
#define CFG_RTC_FREQUENCY			(LSE_VALUE/(CFG_RTC_ASYNCH_PRESCALER + 1))
#else
...
typedef enum
{
    ...
    CFG_IDLEEVT_FLASH_OPER_ALLOWED_ID,
    CFG_IDLEEVT_BLE_TX_FULL_ID,
    CFG_IDLEEVT_SABER_WAIT_ID,
} CFG_IdleEvt_Id_t;
