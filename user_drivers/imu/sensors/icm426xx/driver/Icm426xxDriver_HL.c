                      ...
                      void (*sensor_event_cb)(inv_icm426xx_sensor_event_t *event))
{
    ...
    if (!s->transport.serif.read_reg || !s->transport.serif.write_reg)
        return -1;
...
int inv_icm426xx_device_reset(struct inv_icm426xx *s)
{
    ...
    if (s->transport.serif.serif_type == ICM426XX_UI_I3C && s->transport.serif.configure) {
...
int inv_icm426xx_enable_accel_low_power_mode(struct inv_icm426xx *s)
{
    ...
    if (ICM426XX_PWR_MGMT_0_ACCEL_MODE_LP != accel_mode) {
        ...
        if (s->wu_off_acc_odr_changes >= 8) {
            ...
            new_freq = (cur_freq != ICM426XX_ACCEL_CONFIG0_ODR_1_5625_HZ) ? ICM426XX_ACCEL_CONFIG0_ODR_1_5625_HZ : ICM426XX_ACCEL_CONFIG0_ODR_3_125_HZ;
...
static int inv_icm426xx_configure_serial_interface(struct inv_icm426xx *s)
{
    ...
    case ICM426XX_UI_I3C:
        ...
        if (s->transport.serif.configure)
            status |= s->transport.serif.configure((struct inv_icm426xx_serif *)s);
