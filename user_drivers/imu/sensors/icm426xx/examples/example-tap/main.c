...
/*
 * Tap frequency, internaly tied to accelerometer frequency
 * Use type ICM426XX_ACCEL_CONFIG0_ODR_t to define tap frequency
 * These types are defined in Icm426xxDefs.h.
 *
 * \note The frequency modes to run the Tap are :
 * ICM426XX_ACCEL_CONFIG0_ODR_200_HZ  Low Power mode; reduced detection accuracy
 * ICM426XX_ACCEL_CONFIG0_ODR_500_HZ  Normal mode
 * ICM426XX_ACCEL_CONFIG0_ODR_1_KHZ   High Performance mode
 */
#define ICM_TAP_FREQUENCY_MODE ICM426XX_ACCEL_CONFIG0_ODR_1_KHZ

/*
 * Tap programmable parameters 
 */

/*
 * Minimum pulse magnitude for a valid tap
 */
#define ICM_MINJERK_THRESHOLD ICM426XX_APEX_CONFIG7_TAP_MIN_JERK_THR_281MG_DEFAULT
...
int main(void)
{
	...
	/* Configure Icm426xx */
	rc = ConfigureInvDevice(ICM_TAP_FREQUENCY_MODE, ICM_MINJERK_THRESHOLD);
...
static void SetupMCUHardware(struct inv_icm426xx_serif *icm_serif)
{
	...
	INV_MSG(INV_MSG_LEVEL_INFO, "#   Example Tap   #");
	INV_MSG(INV_MSG_LEVEL_INFO, "###################");
