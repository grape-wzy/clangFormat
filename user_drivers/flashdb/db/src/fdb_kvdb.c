...
void fdb_kv_print(fdb_kvdb_t db)
{
    ...
    FDB_PRINT("size: %u/%u bytes.\r\n", (unsigned int)(using_size + ((SECTOR_NUM - FDB_GC_EMPTY_SEC_THRESHOLD) * SECTOR_HDR_DATA_SIZE)),
        (unsigned int)(db_max_size(db) - db_sec_size(db) * FDB_GC_EMPTY_SEC_THRESHOLD));
