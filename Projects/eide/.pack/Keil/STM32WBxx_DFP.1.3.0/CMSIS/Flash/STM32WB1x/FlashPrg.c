 ...
 * $Revision:    V1.1.2
 *
 * Project:      Flash Programming Functions for ST STM32WB1x Flash
 * --------------------------------------------------------------------------- */

/* History:
*  Version 1.1.2
 *   Fix lastword programming, emptycheck and mass erase while ESE=1
 *  Version 1.00
 *    Initial release
 */
...
int EraseChip (void) {
   ...
   SFSA&=0x000000FF;
   SFSA=((SFSA*0x800)+0x8000000)-0x800;
