 ...
 * $Revision:    V1.1.2
 *
 * Project:      Flash Device Description for ST STM32WB3x Flash
 * --------------------------------------------------------------------------- */
...
#ifdef STM32WB3x_M4_512
struct FlashDevice const FlashDevice  =  {
   FLASH_DRV_VERS,             // Driver Version, do not modify!
   "STM32WB3_M4 512 Flash",        // Device Name 
   ONCHIP,                     // Device Type
...
#endif
#ifdef STM32WB3x_M4_256
struct FlashDevice const FlashDevice  =  {
   FLASH_DRV_VERS,             // Driver Version, do not modify!
   "STM32WB3_M4 256 Flash",        // Device Name 
   ONCHIP,                     // Device Type
   0x08000000,                 // Device Start Address
