  ...
  <generators>
    <generator id="STM32CubeMX" Gvendor="STMicroelectronics" Gtool="STM32CubeMX" Gversion="6.4.0">
      ...
      <project_files>
        ...
        <file category="header" name="STCubeGenerated/Inc/stm32wbxx_it.h"/>
        <file category="source" name="STCubeGenerated/Src/stm32wbxx_it.c"/>
      </project_files>
    </generator>
  </generators>
  <taxonomy>
  ...
  <components>
    <component generator="STM32CubeMX" Cvendor="Keil" Cclass="Device" Cgroup="STM32Cube Framework" Csub="STM32CubeMX" Cversion="1.1.0" condition="STCubeMX">
      ...
      <files>
        ...
        <file category="header" name="STCubeGenerated/Inc/stm32wbxx_hal_conf.h"/>
        [#if peripheralParams.get("RCC")??]
          [#if peripheralParams.get("RCC").get("driver") == ("HAL")]
        <file category="source" name="STCubeGenerated/Src/stm32wbxx_hal_msp.c"/>
          [/#if]
        [/#if]
[#if timebase_tim == true]
        <file category="source" name="STCubeGenerated/Src/stm32wbxx_hal_timebase_tim.c"/>
[/#if]
      </files>
    </component>
  </components>
